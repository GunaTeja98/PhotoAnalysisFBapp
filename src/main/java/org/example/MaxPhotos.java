...
@WebServlet(
        name = "MaxPhotos",
        urlPatterns = "/maxPhotos"
)
public class MaxPhotos extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        long unlikePhoto = 0;
        Filter propertyFilter = new FilterPredicate("likes", FilterOperator.NOT_EQUAL, unlikePhoto);
        ...
        Filter dateFilter = CompositeFilterOperator.and(fromFilter,toFilter);
        ...
        req.getRequestDispatcher("maxPhotos.jsp").forward(req,resp);
    }
